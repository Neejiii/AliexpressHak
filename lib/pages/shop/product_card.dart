...
class _ProductCardState extends State<ProductCard> {
  ...
  @override
  void initState() {
    HttpRequests().getProduct(widget.slug, widget.product.id).then((value) {
                      ...
                      child: GestureDetector(
                          ...
                          child: Container(
                              ...
                              child: Row(
                                  mainAxisAlignment: MainAxisAlignment.center,
                                  children: [
                                    SvgPicture.asset("images/shopping-cart.svg",
                                        height: 22, width: 25.09),
